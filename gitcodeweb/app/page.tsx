  ...
  return (
    <main className="min-h-screen text-[#B5F004] flex flex-col items-center m-16 gap-12">
      <div className="flex flex-col  w-full max-w-[1239px] h-[314px]">
        ...
        <p className="self-center text-center w-full lg:text-[200px] lg:-mt-[120px] pl-8 text-[40px] -mt-[40px]  px-4 ">
          {`{Gitcodĕ-V3}`}
        </p>
      ...
      <div className="flex flex-col gap-6 " >
        ...
        <div className="flex flex-row gap-8" >
          <button className="w-[124px] h-[50px] bg-green-300 text-black font-medium flex items-center justify-center gap-2">
